...
#### The `vmisc#misc#async#periodic_callback()` function
...
#### The `vmisc#misc#escape#shell()` function
...
#### The `vmisc#misc#os#is_win()` function
...
#### The `vmisc#misc#path#which()` function
